    ...
    return (
      <nav className="nav-bar navbar-default header">
        <div className="container-fluid">
          ...
          <div className="col-md-4 text-center"><Link to={this.createNewLink(this.props.forum)}><i className="fa fa-plus-square-o" aria-hidden="true"></i> Create Thread</Link></div>
